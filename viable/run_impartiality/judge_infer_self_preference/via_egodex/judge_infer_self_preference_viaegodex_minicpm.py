...
from utils_effectiveness.inference_minicpm import InferenceMiniCPM
from utils_effectiveness.process_dataset import get_img_files

MODEL_LOCAL_PATH = "PATH/TO/models/openbmb/MiniCPM-V-4_5"
MODEL_TAG = "minicpm"
...
if __name__ == "__main__":
    infer = InferenceMiniCPM(MODEL_LOCAL_PATH)
    for trial in ["A", "B"]:
